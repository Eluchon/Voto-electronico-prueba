...
void nacionalviewer::htmlVoto(nacionalqueue* queue) {
	map<string,string> Get;
			...
			if(Get["Votar"]=="") {
						...
						cout << "<h2>Votacion Nacional</h2>" << endl;
...
nacionaldao::addvoto(Get["Vot"]);
personadao::votoupdatenac(Get["dni"]);
...
void nacionalviewer::htmlCargar(nacionalqueue* queue){
	map<string,string> Get;
		initializeGet(Get);
			...
			cout << "<br/><br/>" << endl;
			cout << "<form><input type='hidden' value='1' name='Panel'><input type='hidden' value='1' name='Cargnac'> <section class='bpadmin'> <button type='submit' name='Agregar' value='1' >Agregar</button></section></form>" << endl;
			cout << "<a href='http://localhost/cgi-bin/main?Panel=1' title='Ir la página anterior'>Volver</a><" << endl;
			}
			if(Get["Agregar"]=="1")  {
if(nacionalcontroller::exist(Get["lista"])) {
...
nacionalcontroller::cargardao(Get["lista"], Get["nombre"], Get["partido"]);

	cout << "<h2>Agregado</h2>" << endl;
	cout << "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=http://localhost/cgi-bin/main?Panel=1&Cargnac=1'>"<< endl;
}
...
void nacionalviewer::htmlModificar(nacionalqueue* queue){
	map<string,string> Get;
			initializeGet(Get);
				...
				cout << "<br/><br/>" << endl;
				cout << "<form><input type='hidden' value='1' name='Panel'><input type='hidden' value='1' name='Modnac'> <section class='bpadmin'> <button type='submit' name='Modificar' value='1' >Modificar</button></section></form>" << endl;
				cout << "<a href='http://localhost/cgi-bin/main?Panel=1' title='Ir la página anterior'>Volver</a><" << endl;
				}
				if(Get["Modificar"]=="1"){
	if(nacionalcontroller::exist(Get["lista"])) {

		nacionalcontroller::modificardao(Get["lista"], Get["nombre"], Get["partido"]);

				cout << "<h2>Modificado</h2>" << endl;
				cout << "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=http://localhost/cgi-bin/main?Panel=1&Modnac=1'>"<< endl;
	}
	else {
...
void nacionalviewer::htmlEliminar(nacionalqueue* queue){
	map<string,string> Get;
			initializeGet(Get);
				...
				cout << "<br/><br/>" << endl;
				cout << "<form><input type='hidden' value='1' name='Panel'><input type='hidden' value='1' name='Elimnac'> <section class='bpadmin'> <button type='submit' name='Eliminar' value='1' >Eliminar</button></section></form>" << endl;
				cout << "<a href='http://localhost/cgi-bin/main?Panel=1' title='Ir la página anterior'>Volver</a><" << endl;
				}
				if(Get["Eliminar"]=="1") {
					if(nacionalcontroller::exist(Get["lista"])){
						nacionalcontroller::eliminardao(Get["lista"]);
										cout << "<h2>Eliminado</h2>" << endl;
										cout << "<META HTTP-EQUIV='REFRESH' CONTENT='5;URL=http://localhost/cgi-bin/main?Panel=1&Elimnac=1'>"<< endl;
					}
					else
...
void nacionalviewer::htmlfin(nacionalqueue* queue) {
	map<string,string> Get;
				initializeGet(Get);
...
void nacionalviewer::htmlestadistica(nacionalqueue* queue){
	cout << "<div class='container'>" << endl;
											cout << "<h2>Estadisticas Nacionales</h2>" << endl;
											cout << "<table class='table'>" << endl;
											cout << "<thead>" << endl;
											cout << " <tr>" << endl;
